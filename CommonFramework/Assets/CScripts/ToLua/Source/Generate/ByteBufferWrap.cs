...
public class ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("WriteBytesByLength", WriteBytesByLength);
		L.RegFunction("WriteBytesWithoutLength", WriteBytesWithoutLength);
		...
		L.RegFunction("ToLuaBuffer", ToLuaBuffer);
	...
	static int _CreateByteBuffer(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(byte[]), typeof(int)))
			{
				...
				ByteBuffer obj = new ByteBuffer(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteBytesByLength(IntPtr L)
	{
		try
		{
			...
			obj.WriteBytesByLength(arg0, arg1);
			return 0;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteBytesWithoutLength(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);

			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(ByteBuffer), typeof(byte[])))
			{
				ByteBuffer obj = (ByteBuffer)ToLua.ToObject(L, 1);
				byte[] arg0 = ToLua.CheckByteBuffer(L, 2);
				obj.WriteBytesWithoutLength(arg0);
				return 0;
			}
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(ByteBuffer), typeof(byte[]), typeof(int)))
			{
				ByteBuffer obj = (ByteBuffer)ToLua.ToObject(L, 1);
				byte[] arg0 = ToLua.CheckByteBuffer(L, 2);
				int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
				obj.WriteBytesWithoutLength(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: ByteBuffer.WriteBytesWithoutLength");
			}
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ToLuaBuffer(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			ByteBuffer obj = (ByteBuffer)ToLua.CheckObject(L, 1, typeof(ByteBuffer));
			LuaInterface.LuaByteBuffer o = obj.ToLuaBuffer();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
