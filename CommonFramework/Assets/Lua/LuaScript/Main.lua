...
--主入口函数。从这里开始lua逻辑
function Main()	
	local id1 =  MessageCenter.AddListener('MsgTest',MsgTest)
	local id2 = MessageCenter.AddListener('MsgTest',MsgTest1)
	local id3 = MessageCenter.AddListener('MsgTest',MsgTest2)
	MessageCenter.AddListener('MsgTest',MsgTest2)
	MessageCenter.RemoveListener(id1)
	MessageCenter.RemoveListener(id2)
	MessageCenter.RemoveListener(id3)
	TestFunc()		
